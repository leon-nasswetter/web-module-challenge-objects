...
console.log(createMenuItem("hamburger", 2, "dinner"));
console.log(createMenuItem("icecream", 1, "dessert"));
...
*/
reviews.push({name:"Leon", rating:5, feedback:"I have had a good time so far, I hope I do well on this weeks sprint challenge"})
// console.log(reviews);
